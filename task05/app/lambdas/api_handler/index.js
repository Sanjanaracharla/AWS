...
export const handler = async (event) => {
  try {
    ...
    // Validate principalId and content
    ...
    // Build DynamoDB item with nested "event" field
    const eventItem = {
      id: eventId, // Top-level for the DynamoDB hash key
      event: {     // Nested structure expected by the test
        id: eventId,
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        event: eventItem.event, // Return the nested event data
      }),
    };
  } catch (error) {
